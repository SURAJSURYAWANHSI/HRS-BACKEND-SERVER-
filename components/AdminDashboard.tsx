    ...
    return (
        <div className="w-full h-full px-4 md:px-8 py-6 flex flex-col gap-6 overflow-x-hidden">
            ...
            <div className="flex-1" id="main-dashboard-content">
                ...
                {currentView === 'DESIGN' && <DesignStage jobs={displayedJobs} onApproveSpec={handleApproveSpec} onSkip={handleSkipStage} onUploadBlueprint={handleUploadBlueprint} onRemoveBlueprint={handleRemoveBlueprint} onDeleteJob={onDeleteJob} onUpdateDesignSubTask={handleUpdateDesignSubTask} onNavigateToNewOrder={onCreateJobClick} onViewDetails={openJobDetail} />}
